...
pub struct AppState {
    ...
    fraud_scoring_service_url: String,
}
...
impl AppState {
    ...
    /// Get the fraud scoring service URL
    pub fn fraud_scoring_service_url(&self) -> &str {
        &self.fraud_scoring_service_url
    }
}
...
async fn main() -> Result<()> {
    ...
    let state = AppState {
        ...
        fraud_scoring_service_url: config.services.fraud_scoring_service_url(),
    };
