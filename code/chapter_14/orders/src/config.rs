...
pub struct ServicesConfig {
    ...
    /// Fraud scoring service host
    pub fraud_scoring_host: String,
    /// Fraud scoring service port
    pub fraud_scoring_port: u16,
}
...
impl ServicesConfig {
    ...
    /// Get the full fraud scoring service URL
    pub fn fraud_scoring_service_url(&self) -> String {
        format!("http://{}:{}", self.fraud_scoring_host, self.fraud_scoring_port)
    }
}
